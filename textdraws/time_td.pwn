...
{
	TEXTDRAW_TIME[playerid][0] = CreatePlayerTextDraw(playerid, 529.666687, 265.755554, "ld_grav:leaf");
	...
	TEXTDRAW_TIME[playerid][1] = CreatePlayerTextDraw(playerid, 559.333312, 250.562988, "12/12/2024");
	...
	TEXTDRAW_TIME[playerid][2] = CreatePlayerTextDraw(playerid, 558.999938, 307.392608, "20:20:20");
	...
	TEXTDRAW_TIME[playerid][3] = CreatePlayerTextDraw(playerid, 531.000061, 321.940795, "ld_grav:leaf");
	...
	TEXTDRAW_TIME[playerid][4] = CreatePlayerTextDraw(playerid, 557.867065, 357.170379, "trenutno_gledate_aplikaciju:~n~vrijeme");
