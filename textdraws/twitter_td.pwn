...
{
	TEXTDRAW_TWITTER[playerid][0] = CreatePlayerTextDraw(playerid, 553.666625, 220.281478, "x");
	...
	TEXTDRAW_TWITTER[playerid][1] = CreatePlayerTextDraw(playerid, 519.666564, 243.096313, "box");
	...
	TEXTDRAW_TWITTER[playerid][2] = CreatePlayerTextDraw(playerid, 519.666564, 276.098327, "box");
	...
	TEXTDRAW_TWITTER[playerid][3] = CreatePlayerTextDraw(playerid, 519.666564, 309.000335, "box");
	...
	TEXTDRAW_TWITTER[playerid][7] = CreatePlayerTextDraw(playerid, 517.599975, 241.296234, "ld_beat:chit");
	...
	TEXTDRAW_TWITTER[playerid][8] = CreatePlayerTextDraw(playerid, 517.599975, 273.983428, "ld_beat:chit");
	...
	TEXTDRAW_TWITTER[playerid][9] = CreatePlayerTextDraw(playerid, 517.599975, 306.385406, "ld_beat:chit");
	...
	TEXTDRAW_TWITTER[playerid][13] = CreatePlayerTextDraw(playerid, 520.867187, 245.559173, "ld_none:ship2");
	...
	TEXTDRAW_TWITTER[playerid][14] = CreatePlayerTextDraw(playerid, 521.067077, 278.314819, "ld_none:ship");
	...
	TEXTDRAW_TWITTER[playerid][15] = CreatePlayerTextDraw(playerid, 520.899963, 310.988708, "ld_none:Ship3");
